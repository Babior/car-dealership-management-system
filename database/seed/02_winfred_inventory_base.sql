...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Corolla' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Toyota')), 'JTDBR32E720000002', 2021, 'Silver', 41200, 148000.00, 169500.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'RAV4' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Toyota')), 'JTMRWRFV8N0000002', 2022, 'Blue', 23800, 258000.00, 289500.00, 'Reserved'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Hilux' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Toyota')), 'AHTBA3CD6P0000002', 2021, 'White', 47600, 286000.00, 318000.00, 'In Service'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Camry' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Toyota')), '4T1G11AK5NU000002', 2020, 'Red', 53400, 184000.00, 209000.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Civic' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Honda')), '2HGFC2F69MH000002', 2022, 'White', 26900, 176000.00, 199500.00, 'Reserved'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'CR-V' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Honda')), '5J6RW2H89NL000002', 2020, 'Black', 60100, 207000.00, 234000.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Altima' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Nissan')), '1N4BL4BV3MN000002', 2020, 'White', 58900, 137000.00, 158000.00, 'In Service'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'X-Trail' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Nissan')), 'JN1TBNT32Z0000002', 2021, 'Silver', 44100, 214000.00, 241000.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Ranger' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Ford')), 'AFAPXXMJ2P0000002', 2022, 'Black', 31600, 312000.00, 349000.00, 'Reserved'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = '3 Series' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'BMW')), 'WBA5R1C08LF000002', 2021, 'Black', 37100, 315000.00, 357000.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'C-Class' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Mercedes-Benz')), 'W1KWF8DB5MR000002', 2022, 'Grey', 21800, 356000.00, 402000.00, 'In Service'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Tucson' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Hyundai')), 'KM8JBCAE8NU000002', 2021, 'White', 42600, 196000.00, 222000.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Sportage' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Kia')), 'KNDPMCAC9N7000002', 2020, 'Silver', 55700, 182000.00, 207000.00, 'Reserved'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Tiguan' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Volkswagen')), '3VV2B7AX4MM000002', 2022, 'Blue', 26400, 244000.00, 276000.00, 'Sold'),
...
((SELECT model_id FROM vehicle_model WHERE model_name = 'Equinox' AND manufacturer_id = (SELECT manufacturer_id FROM manufacturer WHERE manufacturer_name = 'Chevrolet')), '3GNAXKEV6NL000002', 2021, 'Black', 45900, 198000.00, 225000.00, 'In Service');
